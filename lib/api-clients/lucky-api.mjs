...
const DEFAULT_API_BASE_URL = 'http://192.168.3.2:16601';
...
export const getOpenToken = () => (
  getEnv('LUCKY_OPEN_TOKEN', '')
  || getEnv('LUCKY_TOKEN', '')
  || getEnv('LUCKY_API_TOKEN', '')
).trim();
